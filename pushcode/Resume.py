...
main.iconbitmap('E:/OC/pushcode/Python Resume files/face.ico')
main.geometry("750x600")
main.configure(bg='purple')
def cobClick():
    cob = Tk()
    cob.title("Source Code in COBOL")
    cob.iconbitmap('E:/OC/pushcode/Python Resume files/face.ico')
...
def cplusClick():
    ...
    cplus.iconbitmap('E:/OC/pushcode/Python Resume files/face.ico')
...
def pyClick():
    ...
    py.iconbitmap('E:/OC/pushcode/Python Resume files/face.ico')
    py.geometry("800x600")
...
def resClick():
    res = Tk()
    res.title("My Resume")
    res.iconbitmap('E:/OC/pushcode/Python Resume files/face.ico')
    res.geometry("800x600")
    res.configure(bg="purple")
    myLabel = Label(res, text="Resume")
    myLabel.pack()
    myLabel.configure(bg='violet')
    file = open("E:/OC/pushcode/Python Resume files/Resume.doc", "r")
    
def aboutClick():
    about = Tk()
    about.title("Loren Alexander Stevenson")
    about.iconbitmap('E:/OC/pushcode/Python Resume files/face.ico')
...
myLabel.configure(bg='purple')
        # 1 button with "COBOL"
cobol_img = PhotoImage(file="E:/OC/pushcode/Python Resume files/COBOL.png")
...
cobol_btn.configure(width=200, height=100)
        ...
        # 2 button with "C++"
cplus_img = PhotoImage(file="E:/OC/pushcode/Python Resume files/C++.png")
...
py_img = PhotoImage(file="E:/OC/pushcode/Python Resume files/Python.png")
